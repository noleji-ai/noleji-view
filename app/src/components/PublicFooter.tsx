...
export default function PublicFooter({ compact = false }: PublicFooterProps) {
  return (
    <footer className={`border-t border-[#E2E8F0] ${compact ? 'bg-white' : 'bg-[#F7FAFC]'} `}>
      <div className={`mx-auto flex max-w-7xl flex-col gap-4 px-4 ${compact ? 'py-6 sm:flex-row sm:items-center sm:justify-between' : 'py-8 sm:flex-row sm:items-center sm:justify-between'} sm:px-6 lg:px-8`}>
        ...
        <p className="text-[11px] font-bold text-[#1A202C]/25">
          &copy; 2026 Noleji View. All rights reserved.
        </p>
      </div>
    </footer>
  );
