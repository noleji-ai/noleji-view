...
f1: `# docwise v2.5: Desktop Intelligence

> **docwise**는 원본을 훼손하지 않는 로컬 우선 마크다운 관리 도구입니다.
...
> 이 문서는 docwise에서 지원하는 **모든 마크다운 문법**을 정리한 참고 자료입니다.
...
- 링크: \\\`[docwise](https://docwise.coway.com)\\\` → [docwise](https://docwise.coway.com)
- 이미지: \\\`![설명](url)\\\`
...
*이 치트시트는 docwise 사용자를 위해 작성되었습니다.*
`,
...
<body>
  ...
  <div class="footer">
    <p>Apple 스타일 가이드 — docwise 디자인 시스템 레퍼런스</p>
  </div>
</body>
</html>`,
...
<body>
  ...
  <div class="footer">Stripe 컴포넌트 라이브러리 — docwise 디자인 레퍼런스</div>
</body>
</html>`,
...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>docwise — 지혜로운 마크다운 관리</title>
...
<body class="bg-white text-gray-900 antialiased">
  ...
  <section class="min-h-screen flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
    ...
    <div class="relative z-10">
      ...
      <h1 class="text-6xl md:text-8xl font-black tracking-tighter leading-none mb-6">
        <span class="gradient-text">docwise</span>
      </h1>
  ...
  <section class="py-24 px-6 bg-gray-50">
    <div class="max-w-6xl mx-auto">
      ...
      <h2 class="text-4xl font-black tracking-tight mb-16">왜 docwise인가?</h2>
  ...
  <section class="py-24 px-6">
    <div class="max-w-3xl mx-auto text-center">
      ...
      <blockquote class="text-2xl font-semibold text-gray-800 leading-relaxed mb-8">
        docwise를 도입한 후 기획 문서 작성 시간이 40% 단축되었습니다. 특히 PDF 내보내기 품질이 놀랍습니다.
      </blockquote>
      <div>
  ...
  <footer class="py-10 text-center text-gray-400 text-sm border-t border-gray-100">
    <p>© 2026 docwise. 지혜로운 마크다운 관리.</p>
  </footer>
</body>
</html>`,

// f11: 뉴스레터_초안.md — 뉴스레터
f11: `# docwise 뉴스레터 Vol. 3
...
docwise v2.5가 정식 출시되었습니다. 이번 업데이트의 핵심 변경사항:
...
*docwise를 사용해 주셔서 감사합니다.*
*피드백은 docwise-feedback@coway.com으로 보내주세요.*
`,
...
grid-row: span 2;     /* 2행 병합 */</pre>
  ...
  <p class="footer-note">CSS Grid 레이아웃 가이드 — docwise 학습 자료</p>
</body>
</html>`,
